...
if [ -z $configFileIncluded ]; then
	...
	declare -A params=()
	declare -a knownOptions=("identity" "signing_tool" "signtool_options" "notarization_profile" "use_sparkle" "changelog_script_url" "appcast_releases" "appcast_betas" "appcast_releases_fallback" "appcast_betas_fallback" "symbols_symstore_path" "symbols_windows_pdb_server_path" "symbols_macos_dsym_server_path")
